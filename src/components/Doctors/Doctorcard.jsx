      ...
      <Wrapper>
        ...
        <div className='py-8 px-2 font-[Axiforma] flex md:flex-row justify-between flex-col gap-5 '>
          <div className='flex flex-wrap md:flex-row gap-2 md:gap-5'>
            <button className='bg-[#147C84] text-[#FFFFFF] rounded-lg border w-[52px] h-[35px]'>All</button>
            <button className='border-[#147C84] border text-[#000000] rounded-lg font-medium w-[117px] h-[35px] cursor-pointer'>Cardiology</button>
            <button className='border-[#147C84] border text-[#000000] rounded-lg font-medium w-[117px] h-[35px] cursor-pointer'>Emergency</button>
            <button className='border-[#147C84] border text-[#000000] rounded-lg font-medium w-[117px] h-[35px] cursor-pointer'>Neurology</button>
            <button className='border-[#147C84] border text-[#000000] rounded-lg font-medium w-[117px] h-[35px] cursor-pointer'>Pediatric</button>
            <button className='border-[#147C84] border text-[#000000] rounded-lg font-medium w-[117px] h-[35px] cursor-pointer'>Psychiatry</button>
          </div>
          ...
          {displayedDoctors.map((item, index) => (
            <div key={index} className='border-[#147C84] cursor-pointer'>
              ...
              <div className='pt-2 px-5 shadow-xl hover:shadow-2xl rounded-lg pb-4'>
                ...
                {index === 0 ? (
  <Link to={`/doctor-profile/${DoctorcardDb[0]._id}`}>
  ...
  <button className='mt-3 cursor-pointer text-[#0C4C51] hover:text-white text-sm font-mono hover:bg-[#147C84] border border-[#147C84] rounded-lg h-10 justify-center w-full' disabled>
    Book Now
  </button>
)}
              </div>
