...
import Message from "../Modals/Contact"; // Import Contact Modal
    ...
    <Wrapper>
      <div className="grid md:grid-cols-2 gap-8 pt-16 px-2 container mx-auto">
        <div className="w-full">
          <div>
          <h1 className="md:text-[52px] text-3xl pb-3 font-semibold text-[#157c86]">Get In Touch</h1>
          <h2 className="lg:w-[400px] w-full">
        ...
        <div className="md:col-start-2 md:ml-auto">
          <form
            onSubmit={handleSubmit}
            className="bg-[#E8F2F3] md:p-5 p-3 space-y-2 lg:w-[600px] sm:w-full rounded-md text-[#0E575C]"
          >
            <div className="flex justify-between pb-3 gap-2 ">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white p-2 rounded text-[#2632388F]"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full bg-white p-2 text-[#2632388F] rounded"
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full bg-white text-[#2632388F] p-2 rounded max-h-24"
      ...
      {submitted && <Message onClose={() => setSubmitted(false)} />} {/* Modal appears here */}
    </Wrapper>
  );
};
